# Pulled from https://github.com/odysseus9672/SELPythonLibs
# Repository does not provide setup.py, so it's easier to package the module ourselves
# rather than adding as a dependency.
